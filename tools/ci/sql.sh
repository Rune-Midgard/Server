...
mysql -u $DB_ROOT $DB_NAME < sql-files/renewal/item_db_re.sql || aborterror "Unable to import renewal item table."
...
mysql -u $DB_ROOT $DB_NAME < sql-files/renewal/mob_db_re.sql || aborterror "Unable to import renewal monster table."
mysql -u $DB_ROOT $DB_NAME < sql-files/renewal/mob_db2_re.sql || aborterror "Unable to import renewal monster 2 table."
...
mysql -u $DB_ROOT $DB_NAME < sql-files/renewal/mob_skill_db_re.sql || aborterror "Unable to import renewal monster skill table."
mysql -u $DB_ROOT $DB_NAME < sql-files/renewal/mob_skill_db2_re.sql || aborterror "Unable to import renewal monster skill 2 table."
mysql -u $DB_ROOT $DB_NAME < sql-files/tools/roulette_default_data.sql || aborterror "Unable to import roulette table."
