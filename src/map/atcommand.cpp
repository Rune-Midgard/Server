...
ACMD_FUNC(bgstats)
{
	...
	if (!message || !*message)
		...
		if (sscanf(message, "%23[^\n]", atcmd_player_name) < 1) {
			clif_displaymessage(fd,"Please enter a player name (usage: @bgstats <char name/ID>).");
			return -1;
		}
		if ((pl_sd=map_nick2sd(atcmd_player_name,true)) == NULL && (pl_sd=map_charid2sd(atoi(atcmd_player_name))) == NULL) {
			clif_displaymessage(fd, "Character not found");
		...
		if (pl_sd->status.bgstats.showstats) {
			clif_displaymessage(fd, "Character doesn't allow check his statistics.");
			return -1;
		}
		flag = 1;
	}
	char temp[70];
	clif_messagecolor(&sd->bl, color_table[COLOR_RED], "=======================", false, SELF);
	clif_messagecolor(&sd->bl, color_table[COLOR_RED], "===Battleground Stats===", false, SELF);
	clif_messagecolor(&sd->bl, color_table[COLOR_RED], "=======================", false, SELF);
	if (flag) {
		snprintf(temp, sizeof(temp), "Name: %s",pl_sd->status.name); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Wins: %d",pl_sd->status.bgstats.win); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Lost: %d",pl_sd->status.bgstats.lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Tie: %d",pl_sd->status.bgstats.tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Deserter: %d",pl_sd->status.bgstats.deserter); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Kills: %d",pl_sd->status.bgstats.kill_count); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Deaths: %d",pl_sd->status.bgstats.death_count); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Best DMG: %d",pl_sd->status.bgstats.top_damage); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "DMG Done: %d",pl_sd->status.bgstats.damage_done); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "DMG Received: %d",pl_sd->status.bgstats.damage_received); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Heal Done: %d",pl_sd->status.bgstats.healing_done); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Support Skills: %d",pl_sd->status.bgstats.support_skills_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Wrong Heal Done: %d",pl_sd->status.bgstats.wrong_healing_done); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Wrong Support Skills: %d",pl_sd->status.bgstats.wrong_support_skills_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Triple Inferno Wins: %d",pl_sd->status.bgstats.ti_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Triple Inferno Lost: %d",pl_sd->status.bgstats.ti_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Triple Inferno Tie: %d",pl_sd->status.bgstats.ti_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Triple Inferno Skulls: %d",pl_sd->status.bgstats.skulls); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Eye of Storm Wins: %d",pl_sd->status.bgstats.eos_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Eye of Storm Lost: %d",pl_sd->status.bgstats.eos_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Eye of Storm Tie: %d",pl_sd->status.bgstats.eos_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Eye of Storm Bases: %d",pl_sd->status.bgstats.eos_bases); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Wins: %d",pl_sd->status.bgstats.boss_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Lost: %d",pl_sd->status.bgstats.boss_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Tie: %d",pl_sd->status.bgstats.boss_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Boss Kill: %d",pl_sd->status.bgstats.boss_killed); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Flags: %d",pl_sd->status.bgstats.boss_flags); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Wins: %d",pl_sd->status.bgstats.dom_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Lost: %d",pl_sd->status.bgstats.dom_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Tie: %d",pl_sd->status.bgstats.dom_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Def Kill: %d",pl_sd->status.bgstats.dom_def_kills); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Off Kill: %d",pl_sd->status.bgstats.dom_off_kills); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Bases: %d",pl_sd->status.bgstats.dom_bases); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Wins: %d",pl_sd->status.bgstats.td_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Lost: %d",pl_sd->status.bgstats.td_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Tie: %d",pl_sd->status.bgstats.td_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Kills: %d",pl_sd->status.bgstats.td_kills); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Deaths: %d",pl_sd->status.bgstats.td_deaths); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Control Wins: %d",pl_sd->status.bgstats.sc_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Control Lost: %d",pl_sd->status.bgstats.sc_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Control Tie: %d",pl_sd->status.bgstats.sc_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Captured: %d",pl_sd->status.bgstats.sc_captured); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Stolen: %d",pl_sd->status.bgstats.sc_stole); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Dropped: %d",pl_sd->status.bgstats.sc_droped); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Capture the Flag Wins: %d",pl_sd->status.bgstats.ctf_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Capture the Flag Lost: %d",pl_sd->status.bgstats.ctf_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Capture the Flag Tie: %d",pl_sd->status.bgstats.ctf_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "CTF Flag Taken: %d",pl_sd->status.bgstats.ctf_taken); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "CTF Flag Captured: %d",pl_sd->status.bgstats.ctf_captured); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "CTF Flag Dropped: %d",pl_sd->status.bgstats.ctf_droped); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Conquest Wins: %d",pl_sd->status.bgstats.cq_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Conquest Lost: %d",pl_sd->status.bgstats.cq_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Rush Wins: %d",pl_sd->status.bgstats.ru_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Rush Lost: %d",pl_sd->status.bgstats.ru_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Rush Captures: %d",pl_sd->status.bgstats.ru_captures); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "SP Used: %d",pl_sd->status.bgstats.sp_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Zeny Used: %d",pl_sd->status.bgstats.zeny_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Spirit Ball Used: %d",pl_sd->status.bgstats.spiritb_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Total Ammo: %d",pl_sd->status.bgstats.ammo_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Blue Gemstones: %d",pl_sd->status.bgstats.blue_gemstones); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Red Gemstones: %d",pl_sd->status.bgstats.red_gemstones); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Yellow Gemstones: %d",pl_sd->status.bgstats.yellow_gemstones); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Poison Bottle: %d",pl_sd->status.bgstats.poison_bottles); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "HP Potions: %d",pl_sd->status.bgstats.hp_heal_potions); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "SP Potions: %d",pl_sd->status.bgstats.sp_heal_potions); clif_displaymessage(fd, temp);
	}else {
		snprintf(temp, sizeof(temp), "Name: %s",sd->status.name); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Wins: %d",sd->status.bgstats.win); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Lost: %d",sd->status.bgstats.lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Tie: %d",sd->status.bgstats.tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Deserter: %d",sd->status.bgstats.deserter); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Kills: %d",sd->status.bgstats.kill_count); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Deaths: %d",sd->status.bgstats.death_count); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Best DMG: %d",sd->status.bgstats.top_damage); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "DMG Done: %d",sd->status.bgstats.damage_done); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "DMG Received: %d",sd->status.bgstats.damage_received); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Heal Done: %d",sd->status.bgstats.healing_done); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Support Skills: %d",sd->status.bgstats.support_skills_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Wrong Heal Done: %d",sd->status.bgstats.wrong_healing_done); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Wrong Support Skills: %d",sd->status.bgstats.wrong_support_skills_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Triple Inferno Wins: %d",sd->status.bgstats.ti_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Triple Inferno Lost: %d",sd->status.bgstats.ti_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Triple Inferno Tie: %d",sd->status.bgstats.ti_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Triple Inferno Skulls: %d",sd->status.bgstats.skulls); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Eye of Storm Wins: %d",sd->status.bgstats.eos_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Eye of Storm Lost: %d",sd->status.bgstats.eos_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Eye of Storm Tie: %d",sd->status.bgstats.eos_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Eye of Storm Bases: %d",sd->status.bgstats.eos_bases); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Wins: %d",sd->status.bgstats.boss_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Lost: %d",sd->status.bgstats.boss_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Tie: %d",sd->status.bgstats.boss_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Boss Kill: %d",sd->status.bgstats.boss_killed); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Bossnia Flags: %d",sd->status.bgstats.boss_flags); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Wins: %d",sd->status.bgstats.dom_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Lost: %d",sd->status.bgstats.dom_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Tie: %d",sd->status.bgstats.dom_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Def Kill: %d",sd->status.bgstats.dom_def_kills); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Off Kill: %d",sd->status.bgstats.dom_off_kills); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Domination Bases: %d",sd->status.bgstats.dom_bases); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Wins: %d",sd->status.bgstats.td_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Lost: %d",sd->status.bgstats.td_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Tie: %d",sd->status.bgstats.td_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Kills: %d",sd->status.bgstats.td_kills); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Team DeathMatch Deaths: %d",sd->status.bgstats.td_deaths); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Control Wins: %d",sd->status.bgstats.sc_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Control Lost: %d",sd->status.bgstats.sc_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Control Tie: %d",sd->status.bgstats.sc_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Captured: %d",sd->status.bgstats.sc_captured); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Stolen: %d",sd->status.bgstats.sc_stole); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Stone Dropped: %d",sd->status.bgstats.sc_droped); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Capture the Flag Wins: %d",sd->status.bgstats.ctf_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Capture the Flag Lost: %d",sd->status.bgstats.ctf_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Capture the Flag Tie: %d",sd->status.bgstats.ctf_tie); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "CTF Flag Taken: %d",sd->status.bgstats.ctf_taken); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "CTF Flag Captured: %d",sd->status.bgstats.ctf_captured); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "CTF Flag Dropped: %d",sd->status.bgstats.ctf_droped); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Conquest Wins: %d",sd->status.bgstats.cq_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Conquest Lost: %d",sd->status.bgstats.cq_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Rush Wins: %d",sd->status.bgstats.ru_wins); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Rush Lost: %d",sd->status.bgstats.ru_lost); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Rush Captures: %d",sd->status.bgstats.ru_captures); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "SP Used: %d",sd->status.bgstats.sp_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Zeny Used: %d",sd->status.bgstats.zeny_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Spirit Ball Used: %d",sd->status.bgstats.spiritb_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Total Ammo: %d",sd->status.bgstats.ammo_used); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Blue Gemstones: %d",sd->status.bgstats.blue_gemstones); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Red Gemstones: %d",sd->status.bgstats.red_gemstones); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Yellow Gemstones: %d",sd->status.bgstats.yellow_gemstones); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "Poison Bottle: %d",sd->status.bgstats.poison_bottles); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "HP Potions: %d",sd->status.bgstats.hp_heal_potions); clif_displaymessage(fd, temp);
		snprintf(temp, sizeof(temp), "SP Potions: %d",sd->status.bgstats.sp_heal_potions); clif_displaymessage(fd, temp);
	}
	return 0;
}
...
ACMD_FUNC(showstats)
{
	if (sd->status.bgstats.showstats)
	{
		sd->status.bgstats.showstats = 0;
		clif_displaymessage(fd, "BG Stats allowed for everyone.");
	}
	else
	{
		sd->status.bgstats.showstats = 1;
		clif_displaymessage(fd, "BG Stats hidden.");
	}
